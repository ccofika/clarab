...
const BLOCKCYPHER_API_URL = 'https://api.blockcypher.com/v1/doge/main';

/**
 * Get transaction details from Dogecoin network
 */
async function getTransaction(txHash) {
  try {
    ...
    // Calculate fee
    const fee = (tx.fees / 1e8).toFixed(8) + ' DOGE';
    ...
    console.error('Dogecoin lookup error:', error.message);
    return null;
  }
}
