/**
 * Script to import archived tickets from CSV
 * Run with: node scripts/importArchivedTickets.js
 */
...
// Config
const CSV_PATH = path.join(__dirname, '../../total_scores.csv');
const NEVENA_USER_ID = '68e7f3ed3179d31581bd5547';
...
const getOrCreateAgent = async (agentName) => {
  ...
  if (!agent) {
    ...
    agent = await Agent.create({
      name: agentName,
      createdBy: new mongoose.Types.ObjectId(NEVENA_USER_ID),
